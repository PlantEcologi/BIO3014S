...
### >26% of all threatened plants are from Sub-Saharan Africa!!! 
### (7669 of 28661 as of 19 August 2025)
...
There are an estimated 8 (ranging from 3.5 to 108!) million species!!! Most yet to be described!
...
## SA threatened ecosystems are protected by law

```{r echo = F, fig.align = 'center', out.width = '75%'}
knitr::include_graphics("images/sa_rle_gazette.png")
```

Threatened ecosystems are afforded (some) protection under law ([The National Environmental Management: Biodiversity Act (NEM:BA) 2004](https://cer.org.za/virtual-library/legislation/national/biodiversity-and-conservation/national-environmental-management-biodiversity-act-2004)), adding restrictions on land-use activities, requirements for environmental impact assessments (EIAs) for developments within or near these areas, and potential obligations for ecological restoration - _even outside protected areas_.

---

class: center

## We use these threat assessments in other ways
...
```{r echo = F, fig.align = 'center', out.width = '100%'}
knitr::include_graphics("images/wc_bsp2023_map.png")
```
...
```{r echo = F, fig.align = 'center', out.width = '75%'}
knitr::include_graphics("images/wc_bsp2023_categories.png")
```
...
.footnote[Western Cape Biodiversity Spatial Plan [2017](https://www.capenature.co.za/uploads/files/protected-area-management-plans/SANBI_WCBSP-Handbook.pdf) and [2023](https://www.capenature.co.za/western-cape-biodiversity-spatial-plan)]
