...
Just over 150 000 species have been assessed to date (in ±60 years). Only ~62 000 are plants.
...
The IUCN Red List of Ecosystems assesses the threat of ecosystem collapse...
...
## South Africa is ahead of the curve
...
## We use our threat assessments in a range of ways

```{r echo = F, fig.align = 'center', out.width = '60%'}
knitr::include_graphics("images/sa_npaes.png")
```

e.g. informing our protected area expansion strategy ([NPAES 2018](https://www.dffe.gov.za/sites/default/files/docs/national_protectedareas_expansionstrategy2018ofsouthafrica.pdf))
