...
.footnote[[Cheat sheet to the Global Biodiversity Framework](https://www.uib.no/en/cesam/159846/cheat-sheet-kunming-montr%C3%A9al-global-biodiversity-framework).]
...
.left-column[
...and focus on what they hope to preserve.

EBA = birds (BirdLife)

CPD = plants (IUCN)

FF = forests (World Resources Institute)

HBWA and LW = wilderness ([Wildlife Conservation Society](https://www.wcs.org/our-work/places))
...
I'm not going to dwell on this, but it'll come up repeatedly. Ultimately both usually require protected areas. It's usually more about where they are located and how they are managed.

  - e.g. Bontebok National Park used to be burnt very frequently and areas were even fertilized to encourage forage for the Bontebok, often to the detriment of the flora and other species.
...
> Systematic Conservation Planning is a science-driven process of making conservation decisions in a manner that is efficient, repeatable, transparent and equitable.

It typically applies the CARE principles of **C**onnectivity, **A**dequacy, **R**epresentativeness and **E**fficiency, but often considers others too.
...
Connected systems of protected and conserved areas are necessary for species and natural processes to persist in the face of climate change.

These include the flow of individuals, genes, matter (e.g. water or soils) or disturbances (e.g. disease, fire).

Connectivity may be enhanced through better reserve design or the addition of habitat corridors and stepping stones.
...
```{r echo = F, fig.align = 'center', out.width = '100%'}
knitr::include_graphics("images/connectivity.jpg")
```

A conceptual representation of an ecological network for conservation. From [Conservation Corridor](https://conservationcorridor.org/ccsg/what-we-do/projects-and-activities/guidelines/). Designed by Kendra Hoff, CLLC.
...
The conservation area should contain enough of the ecosystem(s) and/or species to ensure they ***persist***. 

This is typically based on minimum target amounts of ecosystems, species and their needs. 

Ideally, this is based on our understanding of their ecology and/or quantitative analysis, e.g. 

- How many individuals are needed to maintain a minimum viable population?
- What is their range size and can they overlap?
- How much of the ecosystem is required to maintain key processes (e.g. fire, hydrology, etc)?
...
knitr::include_graphics("images/fragments_adam.jpg")
```

.footnote[A fragmented landscape in the CFR. Achieving minimum targets may be impossible. We often have to make do with whatever we can conserve and hope it is enough! Photo: Adam Wilson.]
...
Protected areas should represent the full variety of biodiversity at all levels of organization.

Often measured by the number of biodiversity features (species, ecosystems, etc) present in the protected area (or network), or (when considering adequacy) that meet their required targets.
]

.pull-right[

```{r echo = F, fig.align = 'center', out.width = '100%'}
knitr::include_graphics("images/fynbos_critters.jpg")
```

All macroscopic organisms found in one cubic foot of fynbos at Silvermine. Photos: David Liittschwager, National Geographic.
...
The area of land and funding available for conservation are limited, hence there is a need to find the most efficient solutions to conserve the most biodiversity.

There is also recognition that we need to balance conservation against and minimise competition with other human needs - agriculture, housing, etc.
...
There are many other factors which can and should be considered. Most of these are ecological principles, but another key one is just ***Reality*** - protected areas require sufficient funding, political will, defensibility, and local buy-in to support biodiversity over the long term.

Often the establishment of protected areas is driven by key individuals, organisations or lobby groups, but its sustainability depends on many other factors...

.footnote[Image from [Wilson and Primack 2019](https://books.openbookpublishers.com/10.11647/obp.0177/ch13.xhtml#_idTextAnchor552)]
...
```{r echo = F, fig.align = 'center', out.width = '70%'}
knitr::include_graphics("images/WilsonPrimackFig_13.5.png")
```
