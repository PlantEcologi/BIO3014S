...
4. Select additional conservation areas
  - to achieve goals and targets, but subject to constraints on budgets etc
...
6. Maintain the required values of conservation areas
  - Set conservation goals for each area, implement actions, monitor and modify as needed
...
The definition of protected areas (and "conservation"!) differs between regions, as do resources and willingness to implement conservation actions.

"Paper parks" - protected areas on paper, but not in practice...
...
This is often more than half the battle in conservation!
