...
We'll never be able to automate conservation planning and actions, because humans are involved and our priorities change, but we can do better to automate data collection, processing and sharing with decision makers.
...
knitr::include_app("https://emma.eco/", 
  height = "400px")
```
...
```{r echo = F, fig.align = 'center', out.width = '70%'}
knitr::include_graphics("images/multi_vs_hyper.png")
```
...
> ### WARNING!!! Remote sensing can only measure energy in a variety of ways. It is up to us to interpret what these signals mean for various forms of biodiversity on the Earth's surface...

---

class: center, middle

### Remote sensing of biodiversity requires field observations and expert knowledge to help us make sense of the data

```{r echo = F, fig.align = 'center', out.width = '60%'}
knitr::include_graphics("images/turner2014.jpeg")
```

.left[.footnote[[Turner 2014](https://doi-org.ezproxy.uct.ac.za/10.1126/science.1256014)]]
...
```{r echo = F, fig.align = 'centre', out.width = '95%'}
knitr::include_graphics("images/traitmapping.png")
```

.footnote[Leaf traits across 20 [NEON](https://www.neonscience.org/field-sites) field sites.]
...
Map species or cover types based on their reflectance of the electromagnetic spectrum, even where they're smaller than the pixel!
...
```
.left[.footnote[The Cape is currently the epicentre of this endeavour! https://www.bioscape.io/]]
...
.pull-left[
```{r echo = F, fig.align = 'center', out.width= '80%'}
knitr::include_graphics("images/spol.jpg")
```
]
...
More about the project at [**bioscape.io**](https://www.bioscape.io)

Or watch the movie [**here**](https://www.youtube.com/watch?v=Zcbbs3c7jE8)
]
