...
ndvi <- rast("data/20220130_MODIS_v1g_POT_MOD13Q1_006_NDVI.tif")
...
.footnote[From Beisner et al 2003. _Fronties in Ecology and Evolution_]
]
...
```{r echo = F, fig.align = 'center', out.width = '85%'}
knitr::include_graphics("images/slingsby2020_IC.png")
```

.footnote[Slingsby et al 2020. _Global Change Biology_]
...
- e.g. What is the effect of global tree planting? Reduced atmospheric CO2, but increased albedo and evapotranspiration?
