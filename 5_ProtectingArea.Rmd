...
There are a number of different PAME assessment methodologies, but most are based on a similar framework and share common elements, e.g.:
...
.footnote[Remember that 22% (~65) didn't even submit assessments!!!]
...
.pull-left[
### Assisted migration? (Left to right)
...
But most facilities are already at capacity... And even these collections are vulnerable to loss - disease, funding, genetic bottlenecks, etc
...
**Mitigation roles that PAs perform:** 
...
- PA can contribute to climate mitigation via carbon storage and nature-based solutions.
